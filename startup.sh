...
PORTS="16600,16610" LOG_NAME='group0.log' uvicorn "fastapi-webdriver-manager.app:app" --workers 1 --host 0.0.0.0 --port 9560 &
PORTS="16601,16611" LOG_NAME='group1.log' uvicorn "fastapi-webdriver-manager.app:app" --workers 1 --host 0.0.0.0 --port 9561 &
