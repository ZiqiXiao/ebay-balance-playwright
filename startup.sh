...
PORTS="16600,166001" LOG_NAME='group0.log' uvicorn "fastapi-webdriver-manager.app:app" --workers 1 --host 0.0.0.0 --port 9560 &
PORTS="16610,166002" LOG_NAME='group1.log' uvicorn "fastapi-webdriver-manager.app:app" --workers 1 --host 0.0.0.0 --port 9561 &
# PORTS="16602,166003" LOG_NAME='group2.log' uvicorn "fastapi-webdriver-manager.app:app" --workers 1 --host 0.0.0.0 --port 9562 &
